!(function (e) {
  ...
  function (module, exports, __webpack_require__) {
    ...
    var callSiteToString = __webpack_require__(31).callSiteToString,
      eventListenerCount = __webpack_require__(31).eventListenerCount,
      relative = __webpack_require__(1).relative;
    module.exports = depd;
    var basePath = process.cwd();
    function containsNamespace(e, a) {
      for (
        var i = e.split(/[ ,]+/), n = String(a).toLowerCase(), t = 0;
        t < i.length;
        t++
      ) {
        var o = i[t];
        if (o && ("*" === o || o.toLowerCase() === n)) return !0;
      }
      return !1;
    }
    function convertDataDescriptorToAccessor(e, a, i) {
    ...
    function createArgumentsString(e) {
      for (var a = "", i = 0; i < e; i++) a += ", arg" + i;
      return a.substr(2);
    }
    function createStackString(e) {
      var a = this.name + ": " + this.namespace;
    ...
    function depd(e) {
      ...
      var a = callSiteLocation(getStack()[1])[0];
      function i(e) {
        log.call(i, e);
      }
      return (
        (i._file = a),
        (i._ignored = isignored(e)),
        (i._namespace = e),
        (i._traced = istraced(e)),
        (i._warned = Object.create(null)),
        (i.function = wrapfunction),
        (i.property = wrapproperty),
        i
      );
    }
    ...
    function log(e, a) {
      var i = 0 !== eventListenerCount(process, "deprecation");
      if (i || !this._ignored) {
        var n,
          t,
          o,
        ...
        for (
          a
            ? ((s = a),
              ((o = callSiteLocation(p[1])).name = s.name),
              (l = o[0]))
            : (o = s = callSiteLocation(p[(r = 2)]));
          r < p.length;
          r++
        )
          if ((t = (n = callSiteLocation(p[r]))[0]) === l) c = !0;
          else if (t === this._file) l = this._file;
          else if (c) break;
        var u = n ? s.join(":") + "__" + n.join(":") : void 0;
        if (void 0 === u || !(u in this._warned)) {
          this._warned[u] = !0;
          var d = e;
          if (
            (d ||
              (d = o !== s && o.name ? defaultMessage(o) : defaultMessage(s)),
            i)
          ) {
            var m = DeprecationError(this._namespace, d, p.slice(r));
    ...
    function defaultMessage(e) {
      ...
      return (
        "Object" === t && (t = void 0),
        "Function" === t && (t = n.name || t),
        t && a.getMethodName() ? t + "." + i : i
      );
    }
    function formatPlain(e, a, i) {
      var n =
        new Date().toUTCString() + " " + this._namespace + " deprecated " + e;
      if (this._traced) {
        for (var t = 0; t < i.length; t++)
          n += "\n    at " + callSiteToString(i[t]);
        return n;
      }
      return a && (n += " at " + formatLocation(a)), n;
    }
    function formatColor(e, a, i) {
      var n = "[36;1m" + this._namespace + "[22;39m [33;1mdeprecated[22;39m [0m" + e + "[39m";
      if (this._traced) {
        for (var t = 0; t < i.length; t++)
          n += "\n    [36mat " + callSiteToString(i[t]) + "[39m";
        return n;
      }
      return a && (n += " [36m" + formatLocation(a) + "[39m"), n;
    }
    ...
    function wrapproperty(e, a, i) {
      ...
      var t = this,
        o = callSiteLocation(getStack()[1]);
      (o.name = a),
        "value" in n && (n = convertDataDescriptorToAccessor(e, a, i));
      var s = n.get,
        r = n.set;
      "function" == typeof s &&
        (n.get = function () {
          return log.call(t, i, o), s.apply(this, arguments);
        }),
        "function" == typeof r &&
          (n.set = function () {
            return log.call(t, i, o), r.apply(this, arguments);
          }),
        Object.defineProperty(e, a, n);
    }
    function DeprecationError(e, a, i) {
      var n,
        t = new Error();
      return (
        Object.defineProperty(t, "constructor", { value: DeprecationError }),
        ...
        Object.defineProperty(t, "stack", {
          ...
          enumerable: !1,
          get: function () {
            return void 0 !== n ? n : (n = createStackString.call(this, i));
          },
          set: function (e) {
            n = e;
          },
  ...
  function (e, a, i) {
    ...
    function m(e) {
      return function (a, i) {
        var t = n.isBuffer(a) ? a : n.from(a, i);
        return p(t, e);
      };
    }
    function f(e) {
    ...
    (a.etag = m({ weak: !1 })),
      ...
      (a.normalizeType = function (e) {
        return ~e.indexOf("/")
          ? (function (e, a) {
              for (
                var i = e.split(/ *; */),
                  n = { value: i[0], quality: 1, params: {}, originalIndex: a },
                  t = 1;
                t < i.length;
                ++t
              ) {
      ...
      (a.contentDisposition = s.function(
        t,
  ...
  function (e, a, i) {
     ...
     */ (e.exports = function (e, a) {
      ...
      if ("number" == typeof e) return r(e, a);
      return null;
    }),
      (e.exports.format = r),
      (e.exports.parse = c);
    ...
    function r(e, a) {
      ...
      return (
        p || (u = u.replace(t, "$1")), s && (u = u.replace(n, s)), u + r + l
      );
    }
    function c(e) {
  ...
  function (e, a, i) {
    ...
    (e.exports = function e() {
      for (var a, i, t = 500, s = {}, r = 0; r < arguments.length; r++) {
        var p = arguments[r];
        if (p instanceof Error) t = (a = p).status || a.statusCode || t;
        else
          switch (typeof p) {
            case "string":
              i = p;
      ...
      "number" == typeof t &&
        (t < 400 || t >= 600) &&
        n("non-error status code; use only 4xx or 5xx status codes");
      ("number" != typeof t || (!o[t] && (t < 400 || t >= 600))) && (t = 500);
      var l = e[t] || e[c(t)];
      a ||
        ((a = l ? new l(i) : new Error(i || o[t])),
        Error.captureStackTrace(a, e));
      (l && a instanceof l && a.status === t) ||
        ((a.expose = t < 500), (a.status = a.statusCode = t));
      for (var u in s) "status" !== u && "statusCode" !== u && (a[u] = s[u]);
      return a;
    }),
            ...
            case 400:
              n = (function (e, a, i) {
                ...
                return (
                  s(r, e),
                  p(r, n),
                  (r.prototype.status = i),
                  (r.prototype.statusCode = i),
                  (r.prototype.expose = !0),
                  r
                );
              })(i, l, a);
              break;
  ...
  function (e, a, i) {
    ...
    function r(e) {
      ...
      return "+" === e[0] ? "*/*" + e : -1 === e.indexOf("/") ? t.lookup(e) : e;
    }
    function c(e, a) {
      if (!1 === e) return !1;
      var i = a.split("/"),
    ...
    (e.exports = function (e, a) {
      ...
      if (arguments.length > 2) {
        ...
        for (var n = 0; n < i.length; n++) i[n] = arguments[n + 1];
      }
  ...
  function (e, a, i) {
    ...
    function s(e) {
      ...
      if (void 0 !== a) {
        var i = e._parsedUrl;
        return c(a, i) ? i : (((i = r(a))._raw = a), (e._parsedUrl = i));
      }
    }
    function r(e) {
      if ("string" != typeof e || 47 !== e.charCodeAt(0)) return t(e);
      for (var a = e, i = null, n = null, s = 1; s < e.length; s++)
      ...
      var r = void 0 !== o ? new o() : {};
      return (
        (r.path = e),
        (r.href = e),
        (r.pathname = a),
        null !== n && ((r.query = i), (r.search = n)),
        r
      );
    }
    function c(e, a) {
    ...
    (e.exports = s),
      (e.exports.original = function (e) {
        var a = e.originalUrl;
        if ("string" != typeof a) return s(e);
        var i = e._parsedOriginalUrl;
        if (c(a, i)) return i;
        return ((i = r(a))._raw = a), (e._parsedOriginalUrl = i);
      });
  },
  function (e, a, i) {
    "use strict";
    ...
    (a = e.exports = n.function(function (e) {
      var i = {};
      if (e) for (var n in e) "type" !== n && (i[n] = e[n]);
      var t = a.urlencoded(i),
        o = a.json(i);
  ...
  function (e, a, i) {
    ...
    (a.format = function (e) {
      ...
      var a = e.parameters,
        i = e.type;
      if (!i || !c.test(i)) throw new TypeError("invalid type");
      var n = i;
      if (a && "object" == typeof a)
        for (var t, s = Object.keys(a).sort(), r = 0; r < s.length; r++) {
          if (((t = s[r]), !o.test(t)))
      ...
      (a.parse = function (e) {
        ...
        var i = a.indexOf(";"),
          t = -1 !== i ? a.substr(0, i).trim() : a.trim();
        if (!c.test(t)) throw new TypeError("invalid media type");
        var o = new l(t.toLowerCase());
        if (-1 !== i) {
          var r, p, u;
          for (n.lastIndex = i; (p = n.exec(a)); ) {
            if (p.index !== i) throw new TypeError("invalid parameter format");
            (i += p[0].length),
              (r = p[1].toLowerCase()),
              '"' === (u = p[2])[0] &&
                (u = u.substr(1, u.length - 2).replace(s, "$1")),
              (o.parameters[r] = u);
          }
          if (i !== a.length) throw new TypeError("invalid parameter format");
        }
        return o;
      });
  },
  function (e, a, i) {
    ...
    e.exports =
      ...
      ({ __proto__: [] } instanceof Array
        ...
        : function (e, a) {
            for (var i in a) e.hasOwnProperty(i) || (e[i] = a[i]);
            return e;
          });
  },
  function (e, a, i) {
    ...
    function t(e) {
      ...
      var a = parseInt(e, 10);
      if (!isNaN(a)) {
        if (!t[a]) throw new Error("invalid status code: " + a);
        return a;
      }
      if (!(a = t[e.toLowerCase()]))
        throw new Error('invalid status message: "' + e + '"');
      return a;
    }
    (e.exports = t),
      (t.STATUS_CODES = n),
      (t.codes = (function (e, a) {
        var i = [];
        return (
          Object.keys(a).forEach(function (n) {
            var t = a[n],
              o = Number(n);
            (e[o] = t), (e[t] = o), (e[t.toLowerCase()] = o), i.push(o);
          }),
          i
        );
      })(t, n)),
      ...
      (t.empty = { 204: !0, 205: !0, 304: !0 }),
      (t.retry = { 502: !0, 503: !0, 504: !0 });
  },
  function (e, a, i) {
    "use strict";
    /*!
     ...
     */ var n = i(9),
      ...
      s = i(18),
      r = i(87);
    e.exports = function (e, a, i, c, p, l) {
      var u,
        d,
        m = l;
      e._body = !0;
      ...
      try {
        (d = (function (e, a, i) {
          ...
          if ((a('content-encoding "%s"', o), !1 === i && "identity" !== o))
          ...
          switch (o) {
            case "deflate":
              (t = r.createInflate()), a("inflate body"), e.pipe(t);
              break;
            case "gzip":
              (t = r.createGunzip()), a("gunzip body"), e.pipe(t);
              break;
            case "identity":
              (t = e).length = s;
              break;
      ...
      if (
        ((m.length = u),
        (m.encoding = v ? null : f),
        null === m.encoding && null !== f && !o.encodingExists(f))
      )
        return i(
          n(415, 'unsupported charset "' + f.toUpperCase() + '"', {
      ...
      p("read body"),
        t(d, m, function (t, r) {
          ...
          if (v)
            try {
              p("verify body"), v(e, a, r, f);
            } catch (e) {
              return void i(
                n(403, e, { body: r, type: e.type || "entity.verify.failed" })
              );
            }
          var u = r;
          try {
            p("parse body"),
              (u = "string" != typeof r && null !== f ? o.decode(r, f) : r),
              (e.body = c(u));
          } catch (e) {
            return void i(
              n(400, e, { body: u, type: e.type || "entity.parse.failed" })
            );
          }
          i();
        });
  ...
  function (e, a, i) {
     ...
     * MIT Licensed
     */ (e.exports = function (e, a) {
      if (!1 !== o(e)) return t(a, null, e), e;
      return (
        (function (e, a) {
          var i = e.__onFinished;
          (i && i.queue) ||
            ((i = e.__onFinished = (function (e) {
              function a(i) {
                if (
                  ...
                  var n = a.queue;
                  a.queue = null;
                  for (var t = 0; t < n.length; t++) n[t](i, e);
                }
              }
              return (a.queue = []), a;
            })(e)),
            (function (e, a) {
              var i,
                ...
                o = !1;
              function s(e) {
                i.cancel(), t.cancel(), (o = !0), a(e);
              }
              function r(a) {
                e.removeListener("socket", r),
                  o || (i === t && (t = n([[a, "error", "close"]], s)));
              }
              if (((i = t = n([[e, "end", "finish"]], s)), e.socket))
    ...
    function o(e) {
      ...
      return "boolean" == typeof e.finished
        ...
        ? Boolean(e.upgrade || !a || !a.readable || (e.complete && !e.readable))
        : void 0;
    }
  },
  function (e, a, i) {
    ...
    var n = /(?:[^\x21\x25\x26-\x3B\x3D\x3F-\x5B\x5D\x5F\x61-\x7A\x7E]|%(?:[^0-9A-Fa-f]|[0-9A-Fa-f][^0-9A-Fa-f]|$))+/g,
      t = /(^|[^\uD800-\uDBFF])[\uDC00-\uDFFF]|[\uD800-\uDBFF]([^\uDC00-\uDFFF]|$)/g;
  },
  function (e, a, i) {
    "use strict";
    ...
    e.exports = function (e) {
      ...
      for (s = t.index; s < i.length; s++) {
        ...
        r !== s && (o += i.substring(r, s)), (r = s + 1), (o += a);
      }
      return r !== s ? o + i.substring(r, s) : o;
    };
  },
  function (e, a, i) {
    "use strict";
  ...
  function (e, a) {
    e.exports = function (e, a) {
      if (e && a) for (var i in a) e[i] = a[i];
      return e;
    };
  },
  function (e, a, i) {
    "use strict";
    Object.defineProperty(a, "__esModule", { value: !0 }), (a.Logger = void 0);
    var n = (function () {
      function e() {}
      return (
        (e.prototype.info = function (e) {
          console.log(new Date() + "info:::::" + e);
        }),
        (e.prototype.debug = function (e) {
          console.log(new Date() + "debug:::::" + e);
        }),
  ...
  function (e, a, i) {
    ...
    function C(e, a, i) {
      ...
      (this._hidden = Boolean(n.hidden)),
        ...
        (this._extensions =
          void 0 !== n.extensions ? A(n.extensions, "extensions option") : []),
        (this._immutable = void 0 !== n.immutable && Boolean(n.immutable)),
        (this._index =
          void 0 !== n.index ? A(n.index, "index option") : ["index.html"]),
        (this._lastModified =
        ...
        (this._root = n.root ? j(n.root) : null),
    ...
    (e.exports = function (e, a, i) {
      ...
      (C.prototype.index = o.function(function (e) {
        var a = e ? A(e, "paths argument") : [];
        return t("index %o", e), (this._index = a), this;
      }, "send.index: pass index as option")),
      (C.prototype.root = function (e) {
        return (this._root = j(String(e))), t("root %s", this._root), this;
      }),
      ...
      (C.prototype.error = function (e, a) {
        if (z(this, "error"))
          return this.emit("error", n(e, a, { expose: !1 }));
        var i = this.res,
          t = h[e] || String(e),
          o = q("Error", c(t));
        !(function (e) {
          for (var a = O(e), i = 0; i < a.length; i++) e.removeHeader(a[i]);
        })(i),
          a &&
            a.headers &&
            (function (e, a) {
      ...
      (C.prototype.isPreconditionFailure = function () {
        var e = this.req,
          a = this.res,
          i = e.headers["if-match"];
        if (i) {
          var n = a.getHeader("ETag");
          return (
            !n ||
            ("*" !== i &&
              (function (e) {
        ...
        var t = L(e.headers["if-unmodified-since"]);
        if (!isNaN(t)) {
          var o = L(a.getHeader("Last-Modified"));
          return isNaN(o) || o > t;
        }
        return !1;
      }),
      (C.prototype.removeContentHeaderFields = function () {
        for (var e = this.res, a = O(e), i = 0; i < a.length; i++) {
          var n = a[i];
          "content-" === n.substr(0, 8) &&
            "content-location" !== n &&
            e.removeHeader(n);
        }
      }),
      ...
      (C.prototype.isRangeFresh = function () {
        ...
        if (-1 !== e.indexOf('"')) {
          ...
          return Boolean(a && -1 !== e.indexOf(a));
        }
        return L(this.res.getHeader("Last-Modified")) <= L(e);
      }),
      (C.prototype.redirect = function (e) {
        var a = this.res;
        if (z(this, "directory")) this.emit("directory", a, e);
      ...
      (C.prototype.pipe = function (e) {
        ...
        if (-1 === n) return this.error(400), e;
        if (~n.indexOf("\0")) return this.error(400), e;
        if (null !== a) {
          if ((n && (n = k("." + E + n)), S.test(n)))
            return t('malicious path "%s"', n), this.error(403), e;
          (i = n.split(E)), (n = k(w(a, n)));
        } else {
          if (S.test(n)) return t('malicious path "%s"', n), this.error(403), e;
          (i = k(n).split(E)), (n = j(n));
        }
        if (
          (function (e) {
      ...
      (C.prototype.send = function (e, a) {
        ...
        if (
          ...
          if (this._acceptRanges && _.test(c)) {
            if (
              ((c = v(i, c, { combine: !0 })),
              ...
              return (
                ...
                s.setHeader("Content-Range", T("bytes", i)),
                this.error(416, {
            ...
            -2 !== c &&
              ...
              (t("range %j", c),
              (s.statusCode = 206),
              s.setHeader("Content-Range", T("bytes", i, c[0])),
              (p += c[0].start),
          ...
          (o.start = p),
            ...
            s.setHeader("Content-Length", i),
            "HEAD" !== r.method ? this.stream(e, o) : s.end();
        }
      }),
      (C.prototype.sendFile = function (e) {
        var a = 0,
          i = this;
        t('stat "%s"', e),
          u.stat(e, function (n, o) {
            return n && "ENOENT" === n.code && !y(e) && e[e.length - 1] !== E
              ? (function n(o) {
                  if (i._extensions.length <= a)
                    return o ? i.onStatError(o) : i.error(404);
                  var s = e + "." + i._extensions[a++];
                  t('stat "%s"', s),
                    u.stat(s, function (e, a) {
                      return e
                        ? n(e)
                        : a.isDirectory()
                        ? n()
                        : (i.emit("file", s, a), void i.send(s, a));
                    });
                })(n)
              : n
              ? i.onStatError(n)
      ...
      (C.prototype.type = function (e) {
        ...
        if (!a.getHeader("Content-Type")) {
          var i = d.lookup(e);
          if (i) {
            var n = d.charsets.lookup(i);
            t("content-type %s", i),
              a.setHeader("Content-Type", i + (n ? "; charset=" + n : ""));
          } else t("no content-type");
        }
      }),
  ...
  function (e, a, i) {
    ...
    t(e.exports, "callSiteToString", function () {
      var e = Error.stackTraceLimit,
        a = {},
        n = Error.prepareStackTrace;
      (Error.prepareStackTrace = function (e, a) {
        return a;
      }),
      ...
      t(e.exports, "eventListenerCount", function () {
        return n.listenerCount || i(57);
      });
  },
  function (e, a) {
      ...
      function i() {
        if (i.enabled) {
          ...
          for (var s = new Array(arguments.length), r = 0; r < s.length; r++)
            s[r] = arguments[r];
          (s[0] = a.coerce(s[0])), "string" != typeof s[0] && s.unshift("%O");
          var c = 0;
          (s[0] = s[0].replace(/%([a-zA-Z%])/g, function (i, n) {
            if ("%%" === i) return i;
            c++;
            var t = a.formatters[n];
            if ("function" == typeof t) {
              var o = s[c];
              (i = t.call(e, o)), s.splice(c, 1), c--;
            }
            return i;
          })),
            a.formatArgs.call(e, s);
  ...
  function (e, a, i) {
    ...
    (o.encodings = null),
      ...
      (o.encode = function (e, a, i) {
        e = "" + (e || "");
        var t = o.getEncoder(a, i),
          s = t.write(e),
          r = t.end();
        return r && r.length > 0 ? n.concat([s, r]) : s;
      }),
      ...
      (o.getCodec = function (e) {
        o.encodings || (o.encodings = i(69));
        for (var a = o._canonicalizeEncoding(e), n = {}; ; ) {
          var t = o._codecDataCache[a];
          if (t) return t;
          var s = o.encodings[a];
          switch (typeof s) {
            case "string":
            ...
            case "object":
              ...
              n.encodingName || (n.encodingName = a), (a = s.type);
              break;
            case "function":
              return (
      ...
      (o.getDecoder = function (e, a) {
        var i = o.getCodec(e),
          n = new i.decoder(a, i);
        return (
          !i.bomAware || (a && !1 === a.stripBOM) || (n = new t.StripBOM(n, a)),
          n
        );
      });
    var s =
  ...
  function (e, a, i) {
     ...
     */ e.exports = function (e) {
      ...
      if (
        !(function (e) {
          for (var a = e.listeners("data"), i = 0; i < a.length; i++)
            if ("ondata" === a[i].name) return !0;
          return !1;
        })(e)
      )
        return;
      for (var a, i = e.listeners("close"), n = 0; n < i.length; n++)
        ("cleanup" !== (a = i[n]).name && "onclose" !== a.name) || a.call(e);
    };
  },
  function (e, a, i) {
    "use strict";
    ...
    e.exports = {
      ...
      compact: function (e) {
        for (
          ...
          for (
            var o = a[n], s = o.obj[o.prop], r = Object.keys(s), c = 0;
            c < r.length;
            ++c
          ) {
            var p = r[c],
        ...
        for (var t = "", s = 0; s < n.length; ++s) {
          ...
          (r >= 97 && r <= 122)
            ...
            ? (t +=
                ...
                o[128 | (63 & r)])
            : ((s += 1),
              (r = 65536 + (((1023 & r) << 10) | (1023 & n.charCodeAt(s)))),
              (t +=
                o[240 | (r >> 18)] +
                o[128 | ((r >> 12) & 63)] +
                o[128 | ((r >> 6) & 63)] +
      ...
      merge: function e(a, i, o) {
        if (!i) return a;
        if ("object" != typeof i) {
          if (t(a)) a.push(i);
          else {
            if (!a || "object" != typeof a) return [a, i];
        ...
        if (!a || "object" != typeof a) return [a].concat(i);
        var r = a;
        return (
          t(a) && !t(i) && (r = s(a, o)),
          t(a) && t(i)
            ? (i.forEach(function (i, t) {
              ...
              a)
            : Object.keys(i).reduce(function (a, t) {
                var s = i[t];
                return n.call(a, t) ? (a[t] = e(a[t], s, o)) : (a[t] = s), a;
              }, r)
        );
      },
    };
  ...
  function (e, a, i) {
    ...
    function h(e) {
      var a = typeof e;
      return "object" !== a ? a : f.call(e).replace(d, "$1");
    }
    function b(e, a) {
      try {
        return e.match(a);
    ...
    (v.param = function (e, a) {
      ...
      ":" === e[0] &&
        ...
        (e = e.substr(1)));
      for (var o = 0; o < t; ++o) (i = n[o](e, a)) && (a = i);
      ...
      (v.handle = function (e, a, i) {
        var n = this;
        r("dispatching %s %s", e.method, e.url);
        var t = 0,
          o =
            (function (e) {
              ...
              var a = e.indexOf("?"),
                i = -1 !== a ? a : e.length,
                n = e.substr(0, i).indexOf("://");
              return -1 !== n ? e.substr(0, e.indexOf("/", 3 + n)) : void 0;
            })(e.url) || "",
          c = "",
          p = !1,
          u = {},
          ...
          h = (function (e, a) {
            ...
            return function () {
              for (var t = 0; t < i.length; t++) a[i[t]] = n[t];
              return e.apply(this, arguments);
            };
          })(i, e, "baseUrl", "next", "params");
        function g(i) {
          var y = "route" === i ? null : i;
          if (
            (p && ((e.url = e.url.substr(1)), (p = !1)),
            0 !== c.length &&
              ((e.baseUrl = v),
              (e.url = o + c + e.url.substr(o.length)),
              (c = "")),
            "router" !== y)
          )
            if (t >= m.length) setImmediate(h, y);
            else {
              var w,
                k,
                j,
              ...
              if (null == E) return h(y);
              for (; !0 !== k && t < m.length; )
                if (
                  ((k = b((w = m[t++]), E)),
                  (j = w.route),
                  "boolean" != typeof k && (y = y || k),
                  !0 === k && j)
                )
                  if (y) k = !1;
                  else {
                    var _ = e.method,
                      S = j._handles_method(_);
                    S || "OPTIONS" !== _ || x(d, j._options()),
                      S || "HEAD" === _ || (k = !1);
                  }
              if (!0 !== k) return h(y);
              j && (e.route = j),
                (e.params = n.mergeParams
                  ? (function (e, a) {
                      if ("object" != typeof a || !a) return e;
                      var i = s({}, a);
                      if (!(0 in e) || !(0 in a)) return s(i, e);
                      var n = 0,
                        t = 0;
                      for (; n in e; ) n++;
                      for (; t in a; ) t++;
                  ...
                  : w.params);
              var C = w.path;
              n.process_params(w, u, e, a, function (i) {
                return i
                  ? g(y || i)
                  : j
                  ? w.handle_request(e, a, g)
                  : void (function (i, n, t, s) {
                      if (0 !== t.length) {
                        var l = s[t.length];
                        if (l && "/" !== l && "." !== l) return g(n);
                        r("trim prefix (%s) from url %s", t, e.url),
                          (c = t),
                          (e.url = o + e.url.substr(o.length + c.length)),
                          o ||
                            "/" === e.url[0] ||
                            ((e.url = "/" + e.url), (p = !0)),
                          (e.baseUrl =
                      ...
                      r("%s %s : %s", i.name, t, e.originalUrl),
                        n
                          ? i.handle_error(n, e, a, g)
                          : i.handle_request(e, a, g);
                    })(w, y, C, E);
              });
            }
          else setImmediate(h, null);
        }
        (e.next = g),
          "OPTIONS" === e.method &&
            (h = (function (e, a) {
            ...
            : ((m = 0),
              ...
              void 0 !== p && l
                ? u && (u.match === p || (u.error && "route" !== u.error))
                  ? ((i.params[r] = u.value), f(u.error))
                  : ((a[r] = u = { error: null, match: p, value: p }), void v())
                : f());
        }
        function v(e) {
          var a = l[m++];
      ...
      (v.use = function (e) {
        var a = 0,
          i = "/";
        if ("function" != typeof e) {
          for (var n = e; Array.isArray(n) && 0 !== n.length; ) n = n[0];
          "function" != typeof n && ((a = 1), (i = e));
        }
        var o = p(m.call(arguments, a));
        if (0 === o.length)
  ...
  function (e, a, i) {
     ...
     * Copyright(c) 2014-2015 Douglas Christopher Wilson
     * MIT Licensed
     */ var n = i(0)("express:router:route"),
      t = i(21),
      o = i(46),
      s = i(28),
    ...
    (e.exports = p),
      (p.prototype._handles_method = function (e) {
        ...
        var a = e.toLowerCase();
        return (
          "head" !== a || this.methods.head || (a = "get"),
      ...
      (p.prototype._options = function () {
        ...
        for (var a = 0; a < e.length; a++) e[a] = e[a].toUpperCase();
        return e;
      }),
      (p.prototype.dispatch = function (e, a, i) {
        ...
        "head" !== o || this.methods.head || (o = "get"),
          (e.route = this),
          (function s(r) {
            if (r && "route" === r) return i();
            if (r && "router" === r) return i(r);
            var c = t[n++];
            if (!c) return i(r);
            if (c.method && c.method !== o) return s(r);
            r ? c.handle_error(r, e, a, s) : c.handle_request(e, a, s);
          })();
      }),
      (p.prototype.all = function () {
        for (var e = t(r.call(arguments)), a = 0; a < e.length; a++) {
          var i = e[a];
          if ("function" != typeof i) {
            var n = c.call(i),
              s = "Route.all() requires a callback function but got a " + n;
      ...
      s.forEach(function (e) {
        p.prototype[e] = function () {
          for (var a = t(r.call(arguments)), i = 0; i < a.length; i++) {
            var s = a[i];
  ...
  function (e, a, i) {
     ...
     * MIT Licensed
     */ var n = i(100),
      t = i(0)("express:router:layer"),
      o = Object.prototype.hasOwnProperty;
    function s(e, a, i) {
      if (!(this instanceof s)) return new s(e, a, i);
      t("new %o", e);
      var o = a || {};
      (this.handle = i),
    ...
    (e.exports = s),
      (s.prototype.handle_error = function (e, a, i, n) {
        var t = this.handle;
        if (4 !== t.length) return n(e);
        try {
          t(e, a, i, n);
        } catch (e) {
          n(e);
      ...
      (s.prototype.handle_request = function (e, a, i) {
        var n = this.handle;
        if (n.length > 3) return i();
        try {
          n(e, a, i);
        } catch (e) {
          i(e);
      ...
      (s.prototype.match = function (e) {
        ...
        if (null != e) {
          ...
          if (this.regexp.fast_star)
            return (this.params = { 0: r(e) }), (this.path = e), !0;
          a = this.regexp.exec(e);
        }
        if (!a) return (this.params = void 0), (this.path = void 0), !1;
        (this.params = {}), (this.path = a[0]);
        for (var i = this.keys, n = this.params, t = 1; t < a.length; t++) {
          var s = i[t - 1].name,
            c = r(a[t]);
          (void 0 === c && o.call(n, s)) || (n[s] = c);
        }
        return !0;
      });
  },
  function (e, a, i) {
    ...
    e.exports = function (e) {
      var a = n({}, e),
        i = o.parse;
      return (
        "function" == typeof e && ((i = e), (a = void 0)),
        void 0 !== a &&
  ...
  function (e, a, i) {
     ...
     */ (e.exports = function (e, a) {
      var i = a || {},
        ...
        o = (function (e, a) {
          ...
          void 0 === a && (a = !0);
          if ("string" != typeof a && "boolean" != typeof a)
            throw new TypeError("fallback must be a string or boolean");
          if ("string" == typeof a && c.test(a))
            throw new TypeError("fallback must be ISO-8859-1 string");
          var t = n(e),
            o = d.test(t),
            r = "string" != typeof a ? a && h(t) : n(a),
            p = "string" == typeof r && r !== t;
          (p || !o || s.test(t)) && (i["filename*"] = t);
          (o || p) && (i.filename = p ? r : t);
          return i;
        })(e, i.fallback);
      return (function (e) {
        var a = e.parameters,
          i = e.type;
        if (!i || "string" != typeof i || !m.test(i))
          throw new TypeError("invalid type");
        var n = String(i).toLowerCase();
        if (a && "object" == typeof a)
          for (var t, o = Object.keys(a).sort(), s = 0; s < o.length; s++) {
            var r = "*" === (t = o[s]).substr(-1) ? w(a[t]) : y(a[t]);
            n += "; " + t + "=" + r;
          }
        return n;
      })(new k(t, o));
      ...
      (e.exports.parse = function (e) {
        ...
        var a = v.exec(e);
        if (!a) throw new TypeError("invalid type format");
        var i,
          n,
          t = a[0].length,
          o = a[1].toLowerCase(),
        ...
        for (; (a = u.exec(e)); ) {
          if (a.index !== t) throw new TypeError("invalid parameter format");
          if (
            ((t += a[0].length),
            (i = a[1].toLowerCase()),
            (n = a[2]),
    ...
    function x(e) {
      var a = f.exec(e);
      if (!a) throw new TypeError("invalid extended field value");
      var i,
        n = a[1].toLowerCase(),
        o = a[2].replace(r, b);
      switch (n) {
  ...
  function (e, a, i) {
     ...
     */ e.exports = function (e, a) {
      ...
      var i = (function (e) {
          if ("function" == typeof t && e instanceof t) return !0;
          return (
            e &&
            "object" == typeof e &&
            "ctime" in e &&
            "[object Date]" === o.call(e.ctime) &&
            "mtime" in e &&
            "[object Date]" === o.call(e.mtime) &&
            "ino" in e &&
            "number" == typeof e.ino &&
            "size" in e &&
        ...
        s = a && "boolean" == typeof a.weak ? a.weak : i;
      if (!i && "string" != typeof e && !Buffer.isBuffer(e))
        throw new TypeError(
  ...
  function (e, a, i) {
    ...
    e.exports = function (e, a, i) {
      ...
      return i && i.combine
        ? (function (e) {
            for (var a = e.map(n).sort(s), i = 0, r = 1; r < a.length; r++) {
              var c = a[r],
                p = a[i];
              c.start > p.end + 1
                ? (a[++i] = c)
  ...
  function (e, a, i) {
     ...
     */ (e.exports = function (e, a) {
      ...
      if (!a) throw new TypeError("trust argument is required");
      var i = p(e, a);
      return i[i.length - 1];
    }),
      (e.exports.all = p),
    ...
    function p(e, a) {
      ...
      for (var t = 0; t < i.length - 1; t++) a(i[t], t) || (i.length = t + 1);
      return i;
    }
    function l(e) {
        ...
        return 0 === a
          ...
          ? ((n = e[0]),
            ...
            function (e) {
              ...
              var a = r(e);
              if (a.kind() !== o) {
                if (c && !a.isIPv4MappedAddress()) return !1;
          ...
          : ((i = e),
            function (e) {
              if (!s(e)) return !1;
              for (var a, n = r(e), t = n.kind(), o = 0; o < i.length; o++) {
                var c = i[o],
                  p = c[0],
                  l = p.kind(),
                  u = c[1],
    ...
    function u(e) {
      var a = e.lastIndexOf("/"),
        i = -1 !== a ? e.substring(0, a) : e;
      if (!s(i)) throw new TypeError("invalid IP address: " + i);
      var n = r(i);
      -1 === a &&
        "ipv6" === n.kind() &&
        n.isIPv4MappedAddress() &&
        (n = n.toIPv4Address());
      var t = "ipv6" === n.kind() ? 128 : 32,
        c = -1 !== a ? e.substring(a + 1, e.length) : null;
      if (
        (c =
          null === c
            ? t
  ...
  function (e, a, i) {
    ...
    var n = i(7),
      t = i(55),
      o = i(23);
    t.default.set("port", 3080);
    var s = n.createServer(t.default);
    s.listen(3080);
    var r = new o.Logger();
    s.on("listening", function () {
      var e = s.address(),
        a = "string" == typeof e ? "pipe " + e : "port " + e.port;
      r.info("Listening on " + a);
    }),
      (e.exports = t.default);
  },
  function (e, a, i) {
        ...
        c = (function () {
          function a() {
            (this.express = t()),
              ...
              this.routes(),
              (this.users = []),
              (this.logger = new o.Logger());
          }
          return (
            (a.prototype.middleware = function () {
              this.express.use(n.json()),
                this.express.use(n.urlencoded({ extended: !1 })),
                this.express.use(
                  t.static(r.join(e, "../my-app/dist/angular-nodejs-example/"))
                );
            }),
            (a.prototype.routes = function () {
              this.express.get("/", function (a, i, n) {
                i.sendFile(
                  r.join(e, "../my-app/dist/angular-nodejs-example/index.html")
                );
              }),
                this.express.use("/api", s.default),
                this.express.use("*", function (e, a, i) {
                  a.send("Make sure url is correct!!!");
                });
            }),
            a
          );
        })();
      a.default = new c().express;
    }.call(this, "/"));
  },
  function (e, a, i) {
    "use strict";
      ...
      var a = !0,
        i = (function (e) {
          ...
          e.isNative()
            ? (i = "native")
            : e.isEval()
            ? (a = e.getScriptNameOrSourceURL()) || (i = e.getEvalOrigin())
            : (a = e.getFileName());
          if (a) {
            i += a;
        ...
        s = "";
      if (o) {
        var r = e.getMethodName(),
          c = ((p = e.receiver).constructor && p.constructor.name) || null;
        n
          ? (c && 0 !== n.indexOf(c) && (s += c + "."),
            (s += n),
            r &&
              n.lastIndexOf("." + r) !== n.length - r.length - 1 &&
              (s += " [as " + r + "]"))
          : (s += c + "." + (r || "<anonymous>"));
      } else
        t
  ...
  function (e, a, i) {
     ...
     */ var n = i(8),
      t = i(14),
      o = i(9),
      s = i(0)("body-parser:json"),
      r = i(17),
      c = i(11);
    e.exports = function (e) {
      var a = e || {},
        i = "number" != typeof a.limit ? n.parse(a.limit || "100kb") : a.limit,
        u = !1 !== a.inflate,
        d = a.reviver,
        m = !1 !== a.strict,
        f = a.type || "application/json",
        v = a.verify || !1;
      if (!1 !== v && "function" != typeof v)
      ...
      function h(e) {
        ...
        var i;
        try {
          return s("parse json"), JSON.parse(e, d);
        } catch (e) {
          throw l(e, { message: e.message, stack: e.stack });
        }
      }
      return function (e, a, n) {
        if (e._body) return s("body already parsed"), void n();
        if (((e.body = e.body || {}), !c.hasBody(e)))
          return s("skip empty body"), void n();
        if ((s("content-type %j", e.headers["content-type"]), !x(e)))
          return s("skip parsing"), void n();
        var p =
          (function (e) {
            try {
        ...
        r(e, a, n, h, s, { encoding: p, inflate: u, limit: i, verify: v });
      };
    };
      ...
      if ("number" === c && !1 === isNaN(e))
        return a.long
          ...
          : (function (e) {
              ...
              if (e >= t) return Math.round(e / t) + "h";
  ...
  function (e, a, i) {
    var n = i(66),
      t = i(24);
    ((a = e.exports = i(33)).init = function (e) {
      e.inspectOpts = {};
      ...
      1 === o
        ...
        : (function (e) {
            ...
            switch (process.binding("tty_wrap").guessHandleType(e)) {
              ...
              case "FILE":
                var t = i(4);
                (a = new t.SyncWriteStream(e, { autoClose: !1 }))._type = "fs";
                break;
              case "PIPE":
              case "TCP":
                var o = i(34);
  ...
  function (e, a, i) {
    ...
    e.exports = function (e, a, i) {
      var t = i,
        o = a || {};
      (!0 !== a && "string" != typeof a) || (o = { encoding: a });
      "function" == typeof a && ((t = a), (o = {}));
      if (void 0 !== t && "function" != typeof t)
        throw new TypeError("argument callback must be a function");
      if (!t && !global.Promise)
        throw new TypeError("argument callback is required");
      var s = !0 !== o.encoding ? o.encoding : "utf-8",
        r = n.parse(o.limit),
        c = null == o.length || isNaN(o.length) ? null : parseInt(o.length, 10);
      if (t) return p(e, s, c, r, t);
      return new Promise(function (a, i) {
        p(e, s, c, r, function (e, n) {
          if (e) return i(e);
          a(n);
        });
      });
    ...
    function p(e, a, i, n, s) {
      var p = !1;
      if (null !== n && null !== i && i > n)
        return f(
          t(413, "request entity too large", {
            expected: i,
            length: i,
            limit: n,
      ...
      if (e._decoder || (l && (l.encoding || l.decoder)))
        return f(
          t(500, "stream encoding should not be set", {
      ...
      try {
        u = (function (e) {
          ...
          try {
            ...
            if (!r.test(a.message)) throw a;
            throw t(415, "specified encoding unsupported", {
              encoding: e,
              type: "encoding.unsupported",
            });
          }
      ...
      function h(e) {
        if (!p) {
          ...
          if (null !== i && d !== i)
            f(
              t(400, "request size did not match content length", {
                expected: i,
                length: i,
                received: d,
          ...
          else f(null, u ? m + (u.end() || "") : Buffer.concat(m));
        }
      }
      function b() {
        (m = null),
  ...
  function (e, a, i) {
    "use strict";
    for (
      var n = [i(70), i(72), i(73), i(74), i(75), i(76), i(77), i(78)], t = 0;
      t < n.length;
      t++
    ) {
      e = n[t];
  ...
  function (e, a, i) {
    ...
    o.prototype.end || (o.prototype.end = function () {}),
      ...
      (c.prototype.write = function (e) {
        var a = (e = this.prevStr + e).length - (e.length % 4);
        return (
          (this.prevStr = e.slice(a)), (e = e.slice(0, a)), n.from(e, "base64")
        );
      }),
  ...
  function (e, a, i) {
    ...
    function l(e, a) {
      var i = a || "utf-16le";
      if (e.length >= 2)
        if (254 == e[0] && 255 == e[1]) i = "utf-16be";
        else if (255 == e[0] && 254 == e[1]) i = "utf-16le";
        else {
          for (
            var n = 0,
              t = 0,
      ...
      (p.prototype.end = function () {
        if (!this.decoder) {
          var e = n.concat(this.initialBytes),
            a = l(e, this.options.defaultEncoding);
          this.decoder = this.iconv.getDecoder(a, this.options);
  ...
  function (e, a, i) {
    ...
    (r.prototype.write = function (e) {
      for (
        var a = "", i = 0, t = this.inBase64, o = this.base64Accum, s = 0;
        s < e.length;
        s++
      )
        if (t) {
          if (!p[e[s]]) {
            if (s == i && e[s] == d) a += "+";
              ...
              var r = o + e.slice(i, s).toString();
              a += this.iconv.decode(n.from(r, "base64"), "utf16-be");
            }
            e[s] != d && s--, (i = s + 1), (t = !1), (o = "");
          }
        } else
          e[s] == u &&
            ((a += this.iconv.decode(e.slice(i, s), "ascii")),
            (i = s + 1),
            (t = !0));
      if (t) {
        var c = (r = o + e.slice(i).toString()).length - (r.length % 8);
        (o = r.slice(c)),
          (r = r.slice(0, c)),
          (a += this.iconv.decode(n.from(r, "base64"), "utf16-be"));
      } else a += this.iconv.decode(e.slice(i), "ascii");
          ...
          32 <= c && c <= 126
            ...
            : (a || ((o[s++] = m), (a = !0)),
              a &&
                ...
                (i[t++] = 255 & c),
                t == i.length &&
                  ((s += o.write(i.toString("base64").replace(/\//g, ","), s)),
                  (t = 0))));
        }
        return (this.inBase64 = a), (this.base64AccumIdx = t), o.slice(0, s);
      }),
    ...
    (h[",".charCodeAt(0)] = !0),
      (x.prototype.write = function (e) {
          ...
          if (t) {
            if (!h[e[s]]) {
              if (s == i && e[s] == d) a += "&";
                ...
                var r = o + e.slice(i, s).toString().replace(/,/g, "/");
                a += this.iconv.decode(n.from(r, "base64"), "utf16-be");
              }
              e[s] != d && s--, (i = s + 1), (t = !1), (o = "");
            }
        ...
        if (t) {
          var c =
            (r = o + e.slice(i).toString().replace(/,/g, "/")).length -
            (r.length % 8);
          (o = r.slice(c)),
            (r = r.slice(0, c)),
            (a += this.iconv.decode(n.from(r, "base64"), "utf16-be"));
  ...
  function (e, a, i) {
    ...
    function t(e, a) {
      ...
      if (128 === e.chars.length) {
        for (var i = "", t = 0; t < 128; t++) i += String.fromCharCode(t);
        e.chars = i + e.chars;
      }
      this.decodeBuf = n.from(e.chars, "ucs2");
      var o = n.alloc(65536, a.defaultCharSingleByte.charCodeAt(0));
      for (t = 0; t < e.chars.length; t++) o[e.chars.charCodeAt(t)] = t;
      this.encodeBuf = o;
    }
    function o(e, a) {
    ...
    (a._sbcs = t),
      ...
      (s.prototype.write = function (e) {
        for (
          ...
          (t = 2 * e[s]), (i[(o = 2 * s)] = a[t]), (i[o + 1] = a[t + 1]);
  ...
  function (e, a, i) {
    ...
    var n = i(5).Buffer;
    a._dbcs = s;
    for (var t = new Array(256), o = 0; o < 256; o++) t[o] = -1;
    function s(e, a) {
      ...
      (this.decodeTables = []),
        ...
        (this.decodeTableSeq = []);
      for (var n = 0; n < i.length; n++) this._addDecodeChunk(i[n]);
      (this.defaultCharUnicode = a.defaultCharUnicode),
        (this.encodeTable = []),
        (this.encodeTableSeq = []);
      var o = {};
      if (e.encodeSkipVals)
        for (n = 0; n < e.encodeSkipVals.length; n++) {
          var s = e.encodeSkipVals[n];
          if ("number" == typeof s) o[s] = !0;
          else for (var r = s.from; r <= s.to; r++) o[r] = !0;
        }
      ...
      if (
        ((this.defCharSB = this.encodeTable[0][
          a.defaultCharSingleByte.charCodeAt(0)
        ]),
        ...
        var p = this.decodeTables.length,
          l = (this.decodeTables[p] = t.slice(0)),
          u = this.decodeTables.length,
          d = (this.decodeTables[u] = t.slice(0));
        for (n = 129; n <= 254; n++) {
          var m = -1e3 - this.decodeTables[0][n],
            f = this.decodeTables[m];
          for (r = 48; r <= 57; r++) f[r] = -1e3 - p;
        }
        for (n = 129; n <= 254; n++) l[n] = -1e3 - u;
        for (n = 48; n <= 57; n++) d[n] = -2;
      }
    }
    function r(e, a) {
    ...
    function p(e, a) {
      ...
      for (var i = 0, n = e.length; i < n - 1; ) {
        var t = i + Math.floor((n - i + 1) / 2);
        e[t] <= a ? (i = t) : (n = t);
      }
      return i;
    }
    (s.prototype.encoder = r),
      (s.prototype.decoder = c),
      (s.prototype._getDecodeTrieNode = function (e) {
        for (var a = []; e > 0; e >>= 8) a.push(255 & e);
        0 == a.length && a.push(0);
      ...
      (s.prototype._addDecodeChunk = function (e) {
        var a = parseInt(e[0], 16),
          i = this._getDecodeTrieNode(a);
        a &= 255;
          ...
          if ("string" == typeof t)
            for (var o = 0; o < t.length; ) {
              ...
              if (55296 <= s && s < 56320) {
                ...
                i[a++] = 65536 + 1024 * (s - 55296) + (r - 56320);
              } else if (4080 < s && s <= 4095) {
                for (var c = 4095 - s + 2, p = [], l = 0; l < c; l++)
      ...
      (s.prototype._getEncodeBucket = function (e) {
        var a = e >> 8;
        return (
          void 0 === this.encodeTable[a] && (this.encodeTable[a] = t.slice(0)),
          this.encodeTable[a]
        );
      }),
      (s.prototype._setEncodeChar = function (e, a) {
      ...
      (s.prototype._setEncodeSequence = function (e, a) {
        var i,
          n = e[0],
          t = this._getEncodeBucket(n),
          o = 255 & n;
        t[o] <= -10
        ...
        for (var s = 1; s < e.length - 1; s++) {
          ...
          "object" == typeof r
            ? (i = r)
            : ((i = i[n] = {}), void 0 !== r && (i[-1] = r));
        }
        i[(n = e[e.length - 1])] = a;
      }),
      (s.prototype._fillEncodeTable = function (e, a, i) {
        for (var n = this.decodeTables[e], t = 0; t < 256; t++) {
          var o = n[t],
            s = a + t;
          i[s] ||
            (o >= 0
              ...
              : o <= -1e3
              ? this._fillEncodeTable(-1e3 - o, s << 8, i)
              : o <= -10 &&
      ...
      (r.prototype.write = function (e) {
        for (
          ...
          if (void 0 !== t && -1 != c) {
            ...
            "number" == typeof u
              ? (l = u)
              : null == u && void 0 !== (u = t[-1]) && ((l = u), (o = c)),
              (t = void 0);
          } else if (c >= 0) {
            var d = this.encodeTable[c >> 8];
            if ((void 0 !== d && (l = d[255 & c]), l <= -10)) {
              t = this.encodeTableSeq[-10 - l];
              continue;
            }
            if (-1 == l && this.gb18030) {
              var m = p(this.gb18030.uChars, c);
              if (-1 != m) {
                l = this.gb18030.gbChars[m] + (c - this.gb18030.uChars[m]);
                (a[r++] = 129 + Math.floor(l / 12600)),
                  (l %= 12600),
                  (a[r++] = 48 + Math.floor(l / 1260)),
                  (l %= 1260),
                  (a[r++] = 129 + Math.floor(l / 10)),
                  (l %= 10),
                  (a[r++] = 48 + l);
                continue;
              }
          ...
          -1 === l && (l = this.defaultCharSingleByte),
            l < 256
              ? (a[r++] = l)
              : l < 65536
              ? ((a[r++] = l >> 8), (a[r++] = 255 & l))
        ...
        return (this.seqObj = t), (this.leadSurrogate = i), a.slice(0, r);
      }),
      (r.prototype.end = function () {
      ...
      (r.prototype.findIdx = p),
      (c.prototype.write = function (e) {
        var a = n.alloc(2 * e.length),
          i = this.nodeIdx,
          t = this.prevBuf,
          o = this.prevBuf.length,
          s = -this.prevBuf.length;
        o > 0 && (t = n.concat([t, e.slice(0, 10)]));
        for (var r = 0, c = 0; r < e.length; r++) {
          var l,
            u = r >= 0 ? e[r] : t[r + o];
          if ((l = this.decodeTables[i][u]) >= 0);
          else if (-1 === l)
            (r = s), (l = this.defaultCharUnicode.charCodeAt(0));
          else if (-2 === l) {
            var d = s >= 0 ? e.slice(s, r + 1) : t.slice(s + o, r + 1 + o),
              m =
                12600 * (d[0] - 129) +
                1260 * (d[1] - 48) +
                10 * (d[2] - 129) +
                (d[3] - 48),
              f = p(this.gb18030.gbChars, m);
          ...
          if (l > 65535) {
            l -= 65536;
            var h = 55296 + Math.floor(l / 1024);
            (a[c++] = 255 & h), (a[c++] = h >> 8), (l = 56320 + (l % 1024));
          }
          (a[c++] = 255 & l), (a[c++] = l >> 8), (i = 0), (s = r + 1);
        }
        return (
          (this.nodeIdx = i),
          (this.prevBuf = s >= 0 ? e.slice(s) : t.slice(s + o)),
    ...
    (e.exports = function (e) {
      (e.encodeStream = function (a, i) {
        ...
        (e.decodeStream = function (a, i) {
          return new s(e.getDecoder(a, i), i);
        }),
        (e.supportsStreams = !0),
      ...
      (s.prototype._transform = function (e, a, i) {
        if (!n.isBuffer(e))
          return i(
            new Error("Iconv decoding stream needs buffers as its input.")
          );
        try {
          var t = this.conv.write(e);
        ...
        (e.extendNodeEncodings = function () {
          if (!a) {
            ...
            if (
              ...
              (o.prototype.write = function (i, t, o, s) {
                if (isFinite(t)) isFinite(o) || ((s = o), (o = void 0));
                else {
                  var r = s;
                  (s = t), (t = o), (o = r);
                }
                ...
                if (
                  ...
                  n.isNativeEncoding(s))
                )
                  return a.SlowBufferWrite.call(this, i, t, o, s);
                if (i.length > 0 && (o < 0 || t < 0))
                  throw new RangeError("attempt to write beyond buffer bounds");
                var p = e.encode(i, s);
                return p.length < o && (o = p.length), p.copy(this, t, 0, o), o;
              }),
              ...
              (n.byteLength = o.byteLength = function (i, t) {
                return (
              ...
              (n.prototype.write = function (i, t, o, s) {
                var r = t,
                  c = o,
                  p = s;
                if (isFinite(t)) isFinite(o) || ((s = o), (o = void 0));
                ...
                if (
                  ...
                  return a.BufferWrite.call(this, i, r, c, p);
                t = +t || 0;
                var u = this.length - t;
                if (
                  (o ? (o = +o) > u && (o = u) : (o = u),
                  ...
                  throw new RangeError("attempt to write beyond buffer bounds");
                var d = e.encode(i, s);
                return d.length < o && (o = d.length), d.copy(this, t, 0, o), o;
              }),
              e.supportsStreams)
            ) {
              var s = i(10).Readable;
              (a.ReadableSetEncoding = s.prototype.setEncoding),
                (s.prototype.setEncoding = function (a, i) {
  ...
  function (e, a, i) {
    ...
    e.exports = function (e, a) {
      ...
      for (var i = [], t = 0; t < e.length; t++) {
        ...
        for (var s = o[0], r = 1; r < o.length; r++) {
          var c = o[r],
            p = n(c, l);
          s.on(c, p), i.push({ ee: s, event: c, fn: p });
        }
      }
      function l() {
  ...
  function (e, a) {
     ...
     * MIT Licensed
     */
    var i = /; *([!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+) *= *("(?:[ !\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u0020-\u007e])*"|[!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+) */g,
      n = /^[\u0020-\u007e\u0080-\u00ff]+$/,
      t = /^[!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+$/,
      o = /\\([\u0000-\u007f])/g,
      s = /([\\"])/g,
    ...
    (a.format = function (e) {
      ...
      if (!i || !r.test(i)) throw new TypeError("invalid subtype");
      var s = o + "/" + i;
      if (n) {
        if (!c.test(n)) throw new TypeError("invalid suffix");
        s += "+" + n;
      }
      if (a && "object" == typeof a)
      ...
      (a.parse = function (e) {
        ...
        var a,
          ...
          s = e.indexOf(";"),
          r = (function (e) {
            var a = p.exec(e.toLowerCase());
            if (!a) throw new TypeError("invalid media type");
            var i,
              n = a[1],
              t = a[2],
              o = t.lastIndexOf("+");
            -1 !== o && ((i = t.substr(o + 1)), (t = t.substr(0, o)));
            return { type: n, subtype: t, suffix: i };
          })(-1 !== s ? e.substr(0, s) : e),
          c = {};
        i.lastIndex = s;
        for (; (n = i.exec(e)); ) {
          if (n.index !== s) throw new TypeError("invalid parameter format");
          (s += n[0].length),
            (a = n[1].toLowerCase()),
            '"' === (t = n[2])[0] &&
  ...
  function (e, a, i) {
     ...
     * MIT Licensed
     */ var n = i(8),
      t = i(0)("body-parser:raw"),
      o = i(17),
      s = i(11);
    e.exports = function (e) {
      var a = e || {},
        i = !1 !== a.inflate,
        r = "number" != typeof a.limit ? n.parse(a.limit || "100kb") : a.limit,
  ...
  function (e, a, i) {
     ...
     */ var n = i(8),
      t = i(14),
      o = i(0)("body-parser:text"),
      s = i(17),
      r = i(11);
    e.exports = function (e) {
      var a = e || {},
        i = a.defaultCharset || "utf-8",
        c = !1 !== a.inflate,
        p = "number" != typeof a.limit ? n.parse(a.limit || "100kb") : a.limit,
        l = a.type || "text/plain",
        u = a.verify || !1;
      ...
      return function (e, a, n) {
        ...
        s(e, a, n, m, o, { encoding: l, inflate: c, limit: p, verify: u });
      };
    };
  },
  function (e, a, i) {
     ...
     */ var n = i(8),
      t = i(14),
      o = i(9),
      s = i(0)("body-parser:urlencoded"),
      r = i(2)("body-parser"),
      c = i(17),
      p = i(11);
    e.exports = function (e) {
      var a = e || {};
      void 0 === a.extended && r("undefined extended: provide extended option");
      var i = !1 !== a.extended,
        l = !1 !== a.inflate,
        m = "number" != typeof a.limit ? n.parse(a.limit || "100kb") : a.limit,
        f = a.type || "application/x-www-form-urlencoded",
        v = a.verify || !1;
      if (!1 !== v && "function" != typeof v)
        throw new TypeError("option verify must be function");
      var x = i
          ? (function (e) {
              var a = void 0 !== e.parameterLimit ? e.parameterLimit : 1e3,
                i = d("qs");
              if (isNaN(a) || a < 1)
                throw new TypeError(
              ...
              return function (e) {
                ...
                var t = Math.max(100, n);
                return (
                  s("parse extended urlencoding"),
                  i(e, {
                    allowPrototypes: !0,
                    arrayLimit: t,
                    depth: 1 / 0,
          ...
          : (function (e) {
              ...
              return function (e) {
                ...
                return (
                  s("parse urlencoding"), i(e, void 0, void 0, { maxKeys: a })
                );
              };
            })(a),
        h =
      ...
      return function (e, a, i) {
        if (e._body) return s("body already parsed"), void i();
        if (((e.body = e.body || {}), !p.hasBody(e)))
          return s("skip empty body"), void i();
        if ((s("content-type %j", e.headers["content-type"]), !h(e)))
          return s("skip parsing"), void i();
        var n =
          (function (e) {
            try {
              return (t.parse(e).parameters.charset || "").toLowerCase();
    ...
    function u(e, a) {
      for (var i = 0, n = 0; -1 !== (n = e.indexOf("&", n)); )
        if ((n++, ++i === a)) return;
      return i;
    }
    function d(e) {
      var a = l[e];
      if (void 0 !== a) return a.parse;
      switch (e) {
        case "qs":
          a = i(26);
          break;
  ...
  function (e, a, i) {
    ...
    var n = i(40),
      ...
      u = {
        ...
        encoder: n.encode,
        encodeValuesOnly: !1,
        formatter: t.formatters[t.default],
        indices: !1,
      ...
      d = function e(a, i, t, o, s, c, l, d, m, f, v, x, h) {
        var b = a;
        if (
          ("function" == typeof l
            ? (b = l(i, b))
            : b instanceof Date
            ? (b = f(b))
            : "comma" === t && r(b) && (b = b.join(",")),
          null === b)
        ) {
          if (o) return c && !x ? c(i, u.encoder, h) : i;
          b = "";
        }
        if (
          "string" == typeof b ||
          ...
          return c
            ? [v(x ? i : c(i, u.encoder, h)) + "=" + v(c(b, u.encoder, h))]
            : [v(i) + "=" + v(String(b))];
        var g,
          y = [];
    ...
    e.exports = function (e, a) {
      var i,
        ...
        c = (function (e) {
          ...
          var i = t.default;
          if (void 0 !== e.format) {
            if (!o.call(t.formatters, e.format))
          ...
          var n = t.formatters[i],
            s = u.filter;
          return (
            ("function" == typeof e.filter || r(e.filter)) && (s = e.filter),
            {
              addQueryPrefix:
      ...
      l =
        a && a.arrayFormat in s
          ...
          : "indices";
      var f = s[l];
      i || (i = Object.keys(n)), c.sort && i.sort(c.sort);
      for (var v = 0; v < i.length; ++v) {
        var x = i[v];
        (c.skipNulls && null === n[x]) ||
          p(
            m,
            d(
              n[x],
  ...
  function (e, a, i) {
    ...
    var n = i(40),
      ...
      r = function (e, a, i) {
        if (e) {
          ...
          for (var p = 0; null !== (s = o.exec(n)) && p < i.depth; ) {
            if (
              ((p += 1),
              !i.plainObjects &&
          ...
          return (
            s && c.push("[" + n.slice(s.index) + "]"),
            (function (e, a, i) {
              for (var n = a, t = e.length - 1; t >= 0; --t) {
                var o,
                  s = e[t];
                if ("[]" === s && i.parseArrays) o = [].concat(n);
                else {
    ...
    e.exports = function (e, a) {
      var i = (function (e) {
        ...
        var a = void 0 === e.charset ? o.charset : e.charset;
        return {
        ...
        var c =
            "string" == typeof e
              ? (function (e, a) {
                  var i,
                    r = {},
                    c = a.ignoreQueryPrefix ? e.replace(/^\?/, "") : e,
                    p = a.parameterLimit === 1 / 0 ? void 0 : a.parameterLimit,
                    l = c.split(a.delimiter, p),
                    u = -1,
                    d = a.charset;
                  ...
                  for (i = 0; i < l.length; ++i)
                    if (i !== u) {
                      var m,
                        ...
                        h = -1 === x ? v.indexOf("=") : x + 1;
                      -1 === h
                        ? ((m = a.decoder(v, o.decoder, d)),
                          (f = a.strictNullHandling ? null : ""))
                        : ((m = a.decoder(v.slice(0, h), o.decoder, d)),
                          (f = a.decoder(v.slice(h + 1), o.decoder, d))),
                        f &&
                        ...
                        f &&
                          ...
                          f.indexOf(",") > -1 &&
                          (f = f.split(",")),
                        t.call(r, m) ? (r[m] = n.combine(r[m], f)) : (r[m] = f);
                    }
                  return r;
                })(e, i)
              : e,
    ...
    ((a = e.exports = function () {
      ...
      return (
        ...
        (e.request = Object.create(p, {
          app: { configurable: !0, enumerable: !0, writable: !0, value: e },
        })),
  ...
  function (e, a, i) {
     ...
     */ e.exports = function (e, a, i) {
      ...
      if (!a) throw new TypeError("argument src is required");
      void 0 === i && (i = !0);
      return (
  ...
  function (e, a, i) {
     ...
     */ var n = i(99),
      ...
      s = i(101),
      r = i(47),
      c = i(0)("express:application"),
      p = i(102),
      l = i(7),
      u = i(3).compileETag,
      d = i(3).compileQueryParser,
      m = i(3).compileTrust,
      f = i(2)("express"),
      v = i(21),
      x = i(22),
    ...
    (y.init = function () {
      ...
      (y.lazyrouter = function () {
        this._router ||
          ...
          this._router.use(r(this.get("query parser fn"))),
          this._router.use(s.init(this)));
      }),
      (y.handle = function (e, a, i) {
        var t = this._router,
          o = i || n(e, a, { env: this.get("env"), onerror: w.bind(this) });
        if (!t) return c("no routes defined on app"), void o();
        t.handle(e, a, o);
      }),
      (y.use = function (e) {
        var a = 0,
        ...
        return (
          t.forEach(function (e) {
            if (!e || !e.handle || !e.set) return o.use(i, e);
            c(".use app under %s", i),
              (e.mountpath = i),
              (e.parent = this),
              o.use(i, function (a, i, n) {
                var t = a.app;
                e.handle(a, i, function (e) {
      ...
      (y.param = function (e, a) {
        if ((this.lazyrouter(), Array.isArray(e))) {
          for (var i = 0; i < e.length; i++) this.param(e[i], a);
          return this;
        }
      ...
      o.forEach(function (e) {
        y[e] = function (a) {
          if ("get" === e && 1 === arguments.length) return this.set(a);
          this.lazyrouter();
          var i = this._router.route(a);
          return i[e].apply(i, g.call(arguments, 1)), this;
        };
      }),
      (y.all = function (e) {
        this.lazyrouter();
        for (
          var a = this._router.route(e), i = g.call(arguments, 1), n = 0;
          n < o.length;
          n++
        )
          a[o[n]].apply(a, i);
      ...
      (y.render = function (e, a, i) {
        var n,
          ...
          c = {};
        if (
          ("function" == typeof a && ((o = a), (r = {})),
          x(c, this.locals),
          r._locals && x(c, r._locals),
          x(c, r),
            ...
            (i
              ? (void 0 ===
                (g = (function (e) {
                  ...
                  ? (g = (function (e) {
                      var a = e.statusCode;
                      ("number" != typeof a || a < 400 || a > 599) && (a = 500);
                      return a;
                    })(a))
                  : (v = (function (e) {
                      if (!e.headers || "object" != typeof e.headers) return;
                      for (
          ...
          !(function (e, a, i, n, t) {
            function r() {
              ...
              (a.statusCode = i),
                ...
                a.setHeader("X-Content-Type-Options", "nosniff"),
                a.setHeader("Content-Type", "text/html; charset=utf-8"),
                a.setHeader("Content-Length", Buffer.byteLength(s, "utf8")),
                "HEAD" !== e.method ? a.end(s, "utf8") : a.end();
            }
            if (m(e)) return void r();
            p(e), s(e, r), e.resume();
          })(e, a, g, v, b);
        } else n("cannot 404 after headers sent");
      };
    };
  },
  function (e, a) {
      ...
      a = ("^" + a + (s ? "" : "/" === a[a.length - 1] ? "?" : "/?"))
        ...
        .replace(/(\\\/)?(\\\.)?:(\w+)(\(.*?\))?(\*)?(\?)?/g, function (
          ...
          (a = a || ""),
            ...
            (o = o || "([^\\/" + i + "]+?)"),
            (r = r || ""),
            n.push({ name: t, optional: !!r, offset: c + p });
          var l =
            (r ? "" : a) +
            "(?:" +
            i +
        ...
        .replace(/\*/g, function (e, a) {
          for (var i = n.length; i-- > l && n[i].offset > a; ) n[i].offset += 3;
          return "(.*)";
        });
      for (; (o = i.exec(a)); ) {
        for (var m = 0, f = o.index; "\\" === a.charAt(--f); ) m++;
        m % 2 != 1 &&
  ...
  function (e, a, i) {
    ...
    function u(e, a) {
      ...
      if (
        ...
        var s = this.ext.substr(1);
        n('require "%s"', s);
        var r = i(103)(s).__express;
        if ("function" != typeof r)
          throw new Error('Module "' + s + '" does not provide a view engine.');
    ...
    (e.exports = u),
      ...
      (u.prototype.resolve = function (e, a) {
        var i = this.ext,
          ...
          t = d(n);
        return (t && t.isFile()) ||
          ((t = d((n = p(e, r(a, i), "index" + i)))) && t.isFile())
          ? n
          : void 0;
      });
  },
  ...
  function (e, a, i) {
    ...
    e.exports = function (e) {
      if (e instanceof n)
        return (function (e) {
          e.destroy(), "function" == typeof e.close && e.on("open", o);
          return e;
        })(e);
    ...
    (t.prototype.define = function (e) {
      ...
      (t.prototype.load = function (e) {
        ...
        n
          ...
          .split(/[\r\n]+/)
          .forEach(function (e) {
            var i = e.replace(/\s*#.*|^\s*|\s*$/g, "").split(/\s+/);
            a[i.shift()] = i;
          }),
          this.define(a),
          (this._loading = null);
      ...
      (t.prototype.extension = function (e) {
        var a = e.match(/^\s*([^;\s]*)(?:;|\s|$)/)[1].toLowerCase();
  ...
  function (e, a) {
    ...
    e.exports = function (e, a) {
      ...
      if ("string" === r && e.length > 0)
        return (function (e) {
          if ((e = String(e)).length > 100) return;
          var a = /^((?:\d+)?\-?\d?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i.exec(
            e
          );
          if (!a) return;
          var s = parseFloat(a[1]);
      ...
      if ("number" === r && !1 === isNaN(e))
        return a.long
          ? (function (e) {
              var a = Math.abs(e);
              if (a >= o) return s(e, a, o, "day");
              if (a >= t) return s(e, a, t, "hour");
              if (a >= n) return s(e, a, n, "minute");
              if (a >= i) return s(e, a, i, "second");
              return e + " ms";
            })(e)
          : (function (e) {
              var a = Math.abs(e);
              if (a >= o) return Math.round(e / o) + "d";
              if (a >= t) return Math.round(e / t) + "h";
  ...
  function (e, a, i) {
     ...
     */ e.exports = function (e) {
      ...
      return [e.connection.remoteAddress].concat(a);
    };
  },
  function (e, a, i) {
    (function (e) {
      (function () {
        var a, i, n, t, o, s, r;
        (i = {}),
          null !== e && e.exports ? (e.exports = i) : (this.ipaddr = i),
          (r = function (e, a, i, n) {
            var t, o;
          ...
          (i.subnetMatch = function (e, a, i) {
            var n, t, o, s, r;
            for (o in (null == i && (i = "unicast"), a))
              for (
                !(s = a[o])[0] || s[0] instanceof Array || (s = [s]),
                  n = 0,
                  t = s.length;
                n < t;
                n++
                ...
                if (
                  ((r = s[n]), e.kind() === r[0].kind() && e.match.apply(e, r))
                )
                  return o;
            return i;
          }),
          (i.IPv4 = (function () {
            ...
            return (
              ...
              (e.prototype.match = function (e, a) {
                ...
                return r(this.octets, e.octets, 8, a);
              }),
              ...
              (e.prototype.prefixLengthFromSubnetMask = function () {
                ...
                for (
                  ...
                  if (!((n = this.octets[a]) in s)) return null;
                  if (((o = s[n]), t && 0 !== o)) return null;
                  8 !== o && (t = !0), (e += o);
                }
                return 32 - e;
              }),
          ...
          (i.IPv4.parser = function (e) {
            ...
            if (
              ...
              return (function () {
                var e, t, o, s;
                for (s = [], e = 0, t = (o = a.slice(1, 6)).length; e < t; e++)
                  (n = o[e]), s.push(i(n));
                return s;
              })();
            if ((a = e.match(t.longValue))) {
              if ((s = i(a[1])) > 4294967295 || s < 0)
          ...
          (i.IPv6 = (function () {
            function e(e, a) {
              ...
              for (t = 0, o = (r = this.parts).length; t < o; t++)
                if (!(0 <= (s = r[t]) && s <= 65535))
            ...
            return (
              ...
              (e.prototype.toNormalizedString = function () {
                ...
                return (
                  (e = function () {
                    var e, i, n, t;
                    for (t = [], e = 0, i = (n = this.parts).length; e < i; e++)
              ...
              (e.prototype.match = function (e, a) {
                ...
                return r(this.parts, e.parts, 16, a);
              }),
              (e.prototype.SpecialRanges = {
              ...
              (e.prototype.prefixLengthFromSubnetMask = function () {
                ...
                for (
                  ...
                  if (!((n = this.parts[a]) in s)) return null;
                  if (((o = s[n]), t && 0 !== o)) return null;
                  16 !== o && (t = !0), (e += o);
                }
                return 128 - e;
          ...
          (a = function (e, a) {
            ...
            return (
              ...
              ":" === e[e.length - 1] && (e = e.slice(0, -1)),
              {
                parts: (a = (function () {
                  var a, i, n, o;
                  for (o = [], a = 0, i = (n = e.split(":")).length; a < i; a++)
          ...
          (i.IPv6.parser = function (e) {
            var i, n, t, o, r, c, p;
            if (s.native.test(e)) return a(e, 8);
            if (
              (o = e.match(s.transitional)) &&
          ...
          (i.IPv4.isIPv4 = i.IPv6.isIPv6 = function (e) {
          ...
          (i.fromByteArray = function (e) {
            var a;
            if (4 === (a = e.length)) return new i.IPv4(e);
            if (16 === a) return new i.IPv6(e);
            throw new Error(
          ...
          (i.process = function (e) {
            var a;
            return "ipv6" === (a = this.parse(e)).kind() &&
  ...
  function (e, a, i) {
     ...
     */ var n = i(112),
      ...
      l = i(12),
      u = i(53),
      d = Object.create(r.IncomingMessage.prototype);
    function m(e, a, i) {
      Object.defineProperty(e, a, { configurable: !0, enumerable: !0, get: i });
    }
    (e.exports = d),
      (d.get = d.header = function (e) {
      ...
      (d.param = function (e, a) {
        var i = this.params || {},
          n = this.body || {},
          o = this.query || {},
          s = 1 === arguments.length ? "name" : "name, default";
        return (
          t(
            "req.param(" +
              s +
      ...
      m(d, "protocol", function () {
        ...
        if (!this.app.get("trust proxy fn")(this.connection.remoteAddress, 0))
          return e;
        var a = this.get("X-Forwarded-Proto") || e,
          i = a.indexOf(",");
        return -1 !== i ? a.substring(0, i).trim() : a.trim();
      }),
      m(d, "secure", function () {
      ...
      m(d, "subdomains", function () {
        var e = this.hostname;
        if (!e) return [];
        var a = this.app.get("subdomain offset"),
          i = o(e) ? [e] : e.split(".").reverse();
        return i.slice(a);
      }),
      m(d, "path", function () {
  ...
  function (e, a, i) {
    ...
    function s(e) {
      return -1 === e.indexOf("/") ? t.lookup(e) : e;
    }
    function r(e) {
      return "string" == typeof e;
    }
    (e.exports = o),
      (o.prototype.type = o.prototype.types = function (e) {
        var a = e;
        if (a && !Array.isArray(a)) {
          a = new Array(arguments.length);
          for (var i = 0; i < a.length; i++) a[i] = arguments[i];
        }
        if (!a || 0 === a.length) return this.negotiator.mediaTypes();
        if (!this.headers.accept) return a[0];
        var n = a.map(s),
          t = this.negotiator.mediaTypes(n.filter(r)),
          o = t[0];
        return !!o && a[n.indexOf(o)];
      }),
      (o.prototype.encoding = o.prototype.encodings = function (e) {
        var a = e;
        if (a && !Array.isArray(a)) {
          a = new Array(arguments.length);
          for (var i = 0; i < a.length; i++) a[i] = arguments[i];
      ...
      (o.prototype.charset = o.prototype.charsets = function (e) {
        var a = e;
        if (a && !Array.isArray(a)) {
          a = new Array(arguments.length);
          for (var i = 0; i < a.length; i++) a[i] = arguments[i];
      ...
      (o.prototype.lang = o.prototype.langs = o.prototype.language = o.prototype.languages = function (
        e
      ) {
        var a = e;
        if (a && !Array.isArray(a)) {
  ...
  function (e, a, i) {
    ...
    (e.exports = t),
      (e.exports.Negotiator = t),
      (t.prototype.charset = function (e) {
        var a = this.charsets(e);
        return a && a[0];
      }),
      (t.prototype.charsets = function (e) {
        return (0, o("charset").preferredCharsets)(
          this.request.headers["accept-charset"],
          e
        );
      }),
      (t.prototype.encoding = function (e) {
        var a = this.encodings(e);
        return a && a[0];
      }),
      (t.prototype.encodings = function (e) {
        return (0, o("encoding").preferredEncodings)(
      ...
      (t.prototype.languages = function (e) {
        return (0, o("language").preferredLanguages)(
          this.request.headers["accept-language"],
          e
        );
      }),
      (t.prototype.mediaType = function (e) {
        var a = this.mediaTypes(e);
        return a && a[0];
      }),
      (t.prototype.mediaTypes = function (e) {
        return (0, o("mediaType").preferredMediaTypes)(
          this.request.headers.accept,
          e
        );
      }),
      (t.prototype.preferredCharset = t.prototype.charset),
      (t.prototype.preferredCharsets = t.prototype.charsets),
      (t.prototype.preferredEncoding = t.prototype.encoding),
      (t.prototype.preferredEncodings = t.prototype.encodings),
      (t.prototype.preferredLanguage = t.prototype.language),
      (t.prototype.preferredLanguages = t.prototype.languages),
      (t.prototype.preferredMediaType = t.prototype.mediaType),
      (t.prototype.preferredMediaTypes = t.prototype.mediaTypes);
  },
  function (e, a, i) {
    "use strict";
    (e.exports = s), (e.exports.preferredCharsets = s);
    var n = /^\s*([^\s;]+)\s*(?:;(.*))?$/;
    function t(e, a) {
      var i = n.exec(e);
      if (!i) return null;
      var t = i[1],
        o = 1;
      if (i[2])
        for (var s = i[2].split(";"), r = 0; r < s.length; r++) {
          var c = s[r].trim().split("=");
          if ("q" === c[0]) {
            o = parseFloat(c[1]);
            break;
          }
    ...
    function o(e, a, i) {
      var n = 0;
      if (a.charset.toLowerCase() === e.toLowerCase()) n |= 1;
      else if ("*" !== a.charset) return null;
    ...
    function s(e, a) {
      ...
      if (!a) return i.filter(p).sort(r).map(c);
      var n = a.map(function (e, a) {
        return (function (e, a, i) {
  ...
  function (e, a, i) {
    "use strict";
    (e.exports = s), (e.exports.preferredEncodings = s);
    var n = /^\s*([^\s;]+)\s*(?:;(.*))?$/;
    function t(e, a) {
      var i = n.exec(e);
      if (!i) return null;
    ...
    function o(e, a, i) {
      var n = 0;
      if (a.encoding.toLowerCase() === e.toLowerCase()) n |= 1;
      else if ("*" !== a.encoding) return null;
      return { i: i, o: a.i, q: a.q, s: n };
    }
    function s(e, a) {
      var i = (function (e) {
        for (
          var a = e.split(","), i = !1, n = 1, s = 0, r = 0;
          s < a.length;
          s++
        ) {
          var c = t(a[s].trim(), s);
        ...
        return (
          i || (a[r++] = { encoding: "identity", q: n, i: s }),
          (a.length = r),
          a
        );
      })(e || "");
  ...
  function (e, a, i) {
    "use strict";
    (e.exports = s), (e.exports.preferredLanguages = s);
    var n = /^\s*([^\s\-;]+)(?:-([^\s;]+))?\s*(?:;(.*))?$/;
    function t(e, a) {
      var i = n.exec(e);
      if (!i) return null;
      ...
      if (i[3])
        for (var c = i[3].split(";"), p = 0; p < c.length; p++) {
          var l = c[p].split("=");
          "q" === l[0] && (r = parseFloat(l[1]));
        }
      return { prefix: t, suffix: o, q: r, i: a, full: s };
    }
    function o(e, a, i) {
      var n = t(e);
      if (!n) return null;
      var o = 0;
      if (a.full.toLowerCase() === n.full.toLowerCase()) o |= 4;
      else if (a.prefix.toLowerCase() === n.full.toLowerCase()) o |= 2;
      else if (a.full.toLowerCase() === n.prefix.toLowerCase()) o |= 1;
      else if ("*" !== a.full) return null;
      return { i: i, o: a.i, q: a.q, s: o };
    }
    function s(e, a) {
      var i = (function (e) {
        for (var a = e.split(","), i = 0, n = 0; i < a.length; i++) {
  ...
  function (e, a, i) {
    ...
    function o(e, a) {
      ...
      return { type: r, subtype: s, params: t, q: o, i: a };
    }
    function s(e, a, i) {
      var n = o(e),
        t = 0;
      if (!n) return null;
      if (a.type.toLowerCase() == n.type.toLowerCase()) t |= 4;
      else if ("*" != a.type) return null;
      if (a.subtype.toLowerCase() == n.subtype.toLowerCase()) t |= 2;
      else if ("*" != a.subtype) return null;
      var s = Object.keys(a.params);
      if (s.length > 0) {
        if (
          !s.every(function (e) {
            return (
      ...
      return { i: i, o: a.i, q: a.q, s: t };
    }
    function r(e, a) {
      var i = t(void 0 === e ? "*/*" : e || "");
      if (!a) return i.filter(l).sort(c).map(p);
      var n = a.map(function (e, a) {
        return (function (e, a, i) {
          for (var n = { o: -1, q: 0, s: 0 }, t = 0; t < a.length; t++) {
            var o = s(e, a[t], i);
    ...
    function u(e) {
      for (var a = 0, i = 0; -1 !== (i = e.indexOf('"', i)); ) a++, i++;
      return a;
    }
    function d(e) {
      var a,
        ...
        n = e.indexOf("=");
      return (
        -1 === n ? (a = e) : ((a = e.substr(0, n)), (i = e.substr(n + 1))),
        [a, i]
      );
    }
  },
  function (e, a, i) {
    ...
    function S(e, a, i, n) {
      ...
      a.on("directory", function () {
        ...
        i.headers &&
          a.on("headers", function (e) {
            for (
              var a = i.headers, n = Object.keys(a), t = 0;
              t < n.length;
              t++
            ) {
              var o = n[t];
    ...
    function C(e, a, i, n) {
      var t = a || i ? JSON.stringify(e, a, i) : JSON.stringify(e);
      return (
        n &&
    ...
    (E.status = function (e) {
      ...
      (E.send = function (e) {
        ...
        switch (
          ...
          "number" == typeof t &&
            ...
            o("res.send(status): Use res.sendStatus(status) instead"),
            (this.statusCode = t),
            (t = d[t])),
          typeof t)
        ) {
          ...
          case "object":
            if (null === t) t = "";
              ...
              if (!n.isBuffer(t)) return this.json(t);
              this.get("Content-Type") || this.type("bin");
            }
        }
        "string" == typeof t &&
          ((a = "utf8"),
          "string" == typeof (i = this.get("Content-Type")) &&
            this.set("Content-Type", h(i, "utf-8")));
        var c,
          p,
          l = r.get("etag fn"),
        ...
        return (
          ...
          s.fresh && (this.statusCode = 304),
          (204 !== this.statusCode && 304 !== this.statusCode) ||
            (this.removeHeader("Content-Type"),
            this.removeHeader("Content-Length"),
            this.removeHeader("Transfer-Encoding"),
            (t = "")),
          "HEAD" === s.method ? this.end() : this.end(t, a),
          this
        );
      }),
      (E.json = function (e) {
      ...
      (E.jsonp = function (e) {
        ...
        var i = this.app,
          ...
          s = i.get("json spaces"),
          r = C(a, t, s, n),
          c = this.req.query[i.get("jsonp callback name")];
        return (
          this.get("Content-Type") ||
      ...
      (E.sendFile = function (e, a, i) {
        ...
        if (("function" == typeof a && ((n = a), (s = {})), !s.root && !p(e)))
          throw new TypeError(
            "path must be absolute or specify root to res.sendFile"
          );
        var r = encodeURI(e);
        S(this, g(t, r, s), s, function (e) {
          return n
            ? n(e)
            : e && "EISDIR" === e.code
            ? o()
      ...
      (E.sendfile = function (e, a, i) {
        var n = i,
          ...
          o = t.next,
          s = a || {};
        "function" == typeof a && ((n = a), (s = {})),
          S(this, g(t, e, s), s, function (e) {
            return n
              ? n(e)
              : e && "EISDIR" === e.code
              ? o()
      ...
      (E.sendfile = o.function(
        E.sendfile,
        "res.sendfile: Use res.sendFile instead"
      )),
      (E.download = function (e, a, i, n) {
        var o = n,
          s = a,
          r = i || null;
        "function" == typeof a
          ? ((o = a), (s = null), (r = null))
          : "function" == typeof i && ((o = i), (r = null));
        var c = { "Content-Disposition": t(s || e) };
        if (r && r.headers)
          for (var p = Object.keys(r.headers), l = 0; l < p.length; l++) {
            var u = p[l];
            "content-disposition" !== u.toLowerCase() && (c[u] = r.headers[u]);
          }
        (r = Object.create(r)).headers = c;
        var d = k(e);
        return this.sendFile(d, r, o);
      }),
      (E.contentType = E.type = function (e) {
        var a = -1 === e.indexOf("/") ? w.lookup(e) : e;
      ...
      (E.format = function (e) {
        ...
        n && delete e.default;
        var t = Object.keys(e),
          o = t.length > 0 && a.accepts(t);
        if ((this.vary("Accept"), o))
          this.set("Content-Type", v(o).value), e[o](a, this, i);
        else if (n) n();
        else {
          var s = new Error("Not Acceptable");
          (s.status = s.statusCode = 406),
            (s.types = x(t).map(function (e) {
              return e.value;
            })),
            i(s);
        }
      ...
      (E.attachment = function (e) {
        return (
          e && this.type(y(e)), this.set("Content-Disposition", t(e)), this
        );
      }),
      (E.append = function (e, a) {
        var i = this.get(e),
          n = a;
        return (
          i &&
      ...
      (E.set = E.header = function (e, a) {
        if (2 === arguments.length) {
          var i = Array.isArray(a) ? a.map(String) : String(a);
          if ("content-type" === e.toLowerCase()) {
            if (Array.isArray(i))
              throw new TypeError("Content-Type cannot be set to an Array");
            if (!_.test(i)) {
              var n = w.charsets.lookup(i.split(";")[0]);
              n && (i += "; charset=" + n.toLowerCase());
            }
          }
          this.setHeader(e, i);
        } else for (var t in e) this.set(t, e[t]);
        return this;
      }),
      (E.get = function (e) {
        return this.getHeader(e);
      }),
      (E.clearCookie = function (e, a) {
        var i = m({ expires: new Date(1), path: "/" }, a);
        return this.cookie(e, "", i);
      }),
      (E.cookie = function (e, a, i) {
        var n = m({}, i),
          t = this.req.secret,
          o = n.signed;
        if (o && !t)
          throw new Error('cookieParser("secret") required for signed cookies');
        var s = "object" == typeof a ? "j:" + JSON.stringify(a) : String(a);
        return (
          o && (s = "s:" + f(s, t)),
          "maxAge" in n &&
            ((n.expires = new Date(Date.now() + n.maxAge)), (n.maxAge /= 1e3)),
          null == n.path && (n.path = "/"),
          this.append("Set-Cookie", b.serialize(e, String(s), n)),
          this
        );
      }),
      (E.location = function (e) {
        var a = e;
        return (
          "back" === e && (a = this.req.get("Referrer") || "/"),
      ...
      (E.redirect = function (e) {
        ...
        2 === arguments.length &&
          ...
          "HEAD" === this.req.method ? this.end() : this.end(a);
      }),
      (E.vary = function (e) {
        return !e || (Array.isArray(e) && !e.length)
          ? (o("res.vary(): Provide a field name"), this)
          : (j(this, e), this);
      }),
      (E.render = function (e, a, i) {
        var n = this.req.app,
          t = i,
          o = a || {},
          s = this.req,
  ...
  function (e, a, i) {
    ...
    (a.sign = function (e, a) {
      ...
      return (
        e +
        "." +
        n.createHmac("sha256", a).update(e).digest("base64").replace(/\=+$/, "")
      );
    }),
  ...
  function (e, a, i) {
     ...
     */ (a.parse = function (e, a) {
      if ("string" != typeof e)
        throw new TypeError("argument str must be a string");
      for (
        var i = {}, t = a || {}, s = e.split(o), c = t.decode || n, p = 0;
        p < s.length;
        p++
      ) {
        var l = s[p],
          u = l.indexOf("=");
        if (!(u < 0)) {
          var d = l.substr(0, u).trim(),
            m = l.substr(++u, l.length).trim();
          '"' == m[0] && (m = m.slice(1, -1)), null == i[d] && (i[d] = r(m, c));
        }
      }
      return i;
    }),
      (a.serialize = function (e, a, i) {
        ...
        var r = o(a);
        if (r && !s.test(r)) throw new TypeError("argument val is invalid");
        var c = e + "=" + r;
        if (null != n.maxAge) {
          var p = n.maxAge - 0;
  ...
  function (e, a, i) {
    ...
    function t(e, a) {
      ...
      var s = e,
        r = o(e.toLowerCase());
      if (-1 !== i.indexOf("*") || -1 !== r.indexOf("*")) return "*";
      for (var c = 0; c < i.length; c++) {
        var p = i[c].toLowerCase();
        -1 === r.indexOf(p) && (r.push(p), (s = s ? s + ", " + i[c] : i[c]));
      }
      return s;
    }
    function o(e) {
  ...
  function (e, a, i) {
    ...
    (e.exports = function (e, a) {
      ...
      var i = Object.create(a || null),
        p = !1 !== i.fallthrough,
        l = !1 !== i.redirect,
        u = i.setHeaders;
      if (u && "function" != typeof u)
        throw new TypeError("option setHeaders must be function");
      (i.maxage = i.maxage || i.maxAge || 0), (i.root = s(e));
      var d = l
        ? function (e) {
            if (this.hasTrailingSlash()) this.error(404);
            else {
              var a = o.original(this.req);
              (a.path = null),
                (a.pathname = (function (e) {
                  for (var a = 0; a < e.length && 47 === e.charCodeAt(a); a++);
                  return a > 1 ? "/" + e.substr(a) : e;
                })(a.pathname + "/"));
              var i,
                s,
                ...
                p =
                  ((i = "Redirecting"),
                  (s =
                    'Redirecting to <a href="' + t(r) + '">' + t(r) + "</a>"),
                  '<!DOCTYPE html>\n<html lang="en">\n<head>\n<meta charset="utf-8">\n<title>' +
                    i +
                    "</title>\n</head>\n<body>\n<pre>" +
                    s +
  ...
  function (e, a, i) {
    ...
    var n = i(13),
      ...
      r = (function () {
        ...
        return (
          (e.prototype.middleware = function () {
            this.express.use(n.json()),
              this.express.use(n.urlencoded({ extended: !1 }));
          }),
          (e.prototype.routes = function () {
            this.express.use("/", s.default);
          }),
          e
        );
      })();
    a.default = new r().express;
  },
  function (e, a, i) {
    "use strict";
    Object.defineProperty(a, "__esModule", { value: !0 });
    var n = i(13),
      ...
      s = (function () {
        ...
        return (
          ...
          (e.prototype.routes = function () {
            var e = this;
            this.express.get("/users", function (a, i, n) {
              e.logger.info("url:::::" + a.url), i.json(e.users);
            }),
              this.express.get("/users/:userName", function (a, i, n) {
                e.logger.info("url:::::" + a.url);
                var t = e.users.filter(function (e) {
                  if (a.params.userName === e.userName) return e;
                });
                i.json(t);
              }),
              this.express.post("/user", function (a, i, n) {
                e.logger.info("url:::::::" + a.url),
                  e.users.push(a.body.user),
                  i.json(e.users);
              });
          }),
          e
